  ...
  es: {
    translation: {
      ...
      register: {
        ...
        successText: "Tu perfil ha sido registrado correctamente.",
        processing: "Procesando registro...",
        redirectingText: "Estamos preparándolo todo. En unos segundos serás redirigida a la página de pago.",
        redirecting: "Redirigiendo...",
        stripeNotice: "Cargando pasarela de pago segura...",
  ...
  en: {
    translation: {
      ...
      register: {
        ...
        successText: "Your profile has been successfully registered.",
        processing: "Processing registration...",
        redirectingText: "Setting everything up. In a few seconds you will be redirected to the payment page.",
        redirecting: "Redirecting...",
        stripeNotice: "Loading secure payment gateway...",
        goHome: "Back to home"
      },
      footer: {
